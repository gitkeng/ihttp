...
func NewRedisCache(config IRedisConfig) *RedisCache {
	return &RedisCache{
		config:     config,
		oldClients: nil,
		subsribers: &sync.Map{},
...
func (cache *RedisCache) newClient() *redis.Client {
	...
	return redis.NewClient(&redis.Options{
		Addr:            cfg.GetEndpoint(),
		Password:        cfg.GetPassword(),
		DB:              cfg.GetDB(),
		PoolSize:        cfg.GetPoolSize(),
		MinIdleConns:    cfg.GetMinIdleConns(),
		MaxRetries:      cfg.GetMaxRetries(),
		MinRetryBackoff: cfg.GetMinRetryBackoff(),
		MaxRetryBackoff: cfg.GetMaxRetryBackoff(),
		ConnMaxIdleTime: cfg.GetMaxIdleTime(),
...
func (cache *RedisCache) getClient() (*redis.Client, error) {
	...
	for {
		...
		if retries > len(retriesDelayMs)-1 {
			return nil, fmt.Errorf("redis: retry exceed limits")
		}
		...
		if err != nil {
			...
			cache.client = nil
			log.Warnf("redis context name %s connect fail with err %s", cache.config.GetContextName(), err.Error())
			continue
		}
...
func (cache *RedisCache) Open() error {
...
func (cache *RedisCache) KeysN(pattern string) ([]string, error) {
...
func (cache *RedisCache) getRetriesDelayInMs() []int {
	return []int{1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000,
		1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000}
}

func (cache *RedisCache) isNoConnectionError(err error) bool {
	if err == nil {
		return false
	}

	errMsgLower := strings.ToLower(err.Error())
	if strings.Contains(errMsgLower, "connect: dbConn refused") {
		return true
	}
...
func (cache *RedisCache) Expire(key string, expire time.Duration) error {
...
func (cache *RedisCache) Decr(key string) (int, error) {
...
func (cache *RedisCache) Incr(key string) (int, error) {
...
func (cache *RedisCache) DecrBy(key string, value int) (int, error) {
...
func (cache *RedisCache) IncrBy(key string, value int) (int, error) {
...
func (cache *RedisCache) SetSNoExpire(key string, value string) error {
...
func (cache *RedisCache) SetNoExpire(key string, value interface{}) error {
...
func (cache *RedisCache) SetS(key string, value string, expire time.Duration) error {
...
func (cache *RedisCache) Set(key string, value interface{}, expire time.Duration) error {
...
func (cache *RedisCache) HFields(key string, pattern string) ([]string, error) {
...
func (cache *RedisCache) HMSet(key string, fieldValues map[string]interface{}) error {
...
func (cache *RedisCache) HDecr(key string, field string) (int, error) {
...
// Incr do a counter on key, return first counter if cache expire
func (cache *RedisCache) HIncr(key string, field string) (int, error) {
...
func (cache *RedisCache) HDecrBy(key string, field string, value int) (int, error) {
...
func (cache *RedisCache) HIncrBy(key string, field string, value int) (int, error) {
...
func (cache *RedisCache) HSetSNoExpire(key string, field string, value string) error {
...
func (cache *RedisCache) HSetS(key string, field string, value string, expire time.Duration) error {
...
func (cache *RedisCache) BitFieldBulkUpdate(cmds []*BitFieldCmd) error {
	if len(cmds) == 0 {
		return nil
	}
...
func (cache *RedisCache) BitFieldGet(key string, byteSize int, position int) (int64, error) {
...
func (cache *RedisCache) BitFieldSet(key string, byteSize int, position int, value interface{}) (int64, error) {
...
func (cache *RedisCache) BitFieldIncrBy(key string, byteSize int, position int, value int64) (int64, error) {
...
func (cache *RedisCache) BitField(
	key string,
...
func (cache *RedisCache) Autonumber(name string) (int, error) {
...
func (cache *RedisCache) Autonumbers(name string, n int) ([]int, error) {
	if n < 0 {
...
func (cache *RedisCache) Pub(channel string, message interface{}) error {
	...
	for {
		retries++
		if retries > len(retriesDelayMs)-1 {
			return fmt.Errorf("RedisCache: retry exceed limits")
		}
...
func (cache *RedisCache) Sub(channels ...string) (<-chan *redis.Message /*subID (used for close)*/, string, error) {
...
func (cache *RedisCache) Unsub(subID string) error {
	if len(subID) == 0 {
		return nil
	}
